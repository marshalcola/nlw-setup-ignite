...
export function HabitsList({ date, onCompletedChanged }: HabitListsProps) {
  const [habitsInfo, setHabitsInfo] = useState<HabisInfo>()
  ...
  async function handleToggleHabit(habitId: string) {
    ...
    // Desabilita checkar quando a data for passada
